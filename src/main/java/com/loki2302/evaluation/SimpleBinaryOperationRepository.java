...
public class SimpleBinaryOperationRepository implements BinaryOperationRepository {
	private final List<BinaryOperationDefinition> definitions;
	
	public SimpleBinaryOperationRepository(List<BinaryOperationDefinition> definitions) {
